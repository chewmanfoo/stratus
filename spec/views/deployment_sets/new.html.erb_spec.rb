...
describe "deployment_sets/new" do
  before(:each) do
    assign(:deployment_set, stub_model(DeploymentSet,
      :application_id => 1,
  ...
  it "renders new deployment_set form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", deployment_sets_path, "post" do
