...
describe "app_sync_reports/edit" do
  before(:each) do
  ...
  it "renders the edit app_sync_report form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => app_sync_reports_path(@app_sync_report), :method => "post" do
